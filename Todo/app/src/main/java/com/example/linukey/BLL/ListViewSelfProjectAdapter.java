...
public class ListViewSelfProjectAdapter extends BaseAdapter {
    Context context;
    List<Project> datasource;
    ...
    public ListViewSelfProjectAdapter(Context context, List<Project> datasource){
