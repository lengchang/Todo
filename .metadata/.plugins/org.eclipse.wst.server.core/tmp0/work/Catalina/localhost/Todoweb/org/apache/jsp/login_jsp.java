 ...
 * Generated at: 2016-12-13 17:40:10 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<a href=\"findpwd.html\" id=\"forget_pass_span\">忘记密码？</a>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<br/>\n");
      out.write("\t\t\t\t<div id=\"usergroup\">\n");
      out.write("\t\t\t\t<input type=\"radio\" id=\"normaluser\" name=\"usergroup\" value=\"普通用户\" checked /><span>普通用户</span> \n");
      out.write("\t\t\t\t<input type=\"radio\" name=\"usergroup\" value=\"管理员\" /><span>管理员</span>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<br/>\n");
  ...
  private boolean _jspx_meth_s_005finclude_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /login.jsp(36,2) name = value type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
