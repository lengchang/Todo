 ...
 * Generated at: 2016-12-12 12:40:30 UTC
...
return;
    ...
    try {
      ...
      if (_jspx_meth_s_005ffielderror_005f0(_jspx_page_context))
        return;
      out.write("\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"user_name\" name=\"username\" placeholder=\"用户名/邮箱\" required><br />\n");
      out.write("\t\t\t\t<input type=\"password\" id=\"user_pass\" name=\"password\" placeholder=\"密码\" required ><br />\n");
      out.write("\t\t\t\t<div id=\"about_pass\">\n");
      out.write("\t\t\t\t\t<span id=\"remember_pass_span\"><input type=\"checkbox\">记住我</span>\n");
      out.write("\t\t\t\t\t<a href=\"findpwd.html\"><span id=\"forget_pass_span\">忘记密码？</span></a><br/>\n");
      out.write("\t\t\t\t\t<input type=\"radio\" name=\"usergroup\" value=\"普通用户\" checked />普通用户\n");
      out.write("\t\t\t\t\t<input type=\"radio\" name=\"usergroup\" value=\"管理员\" />管理员\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<input type=\"submit\" value=\"登录\" id=\"login_button\"><br />\n");
      out.write("\t\t\t</form>\n");
      out.write("\t\t\t<a href=\"./register.jsp\" id=\"gotoregist\">尚无账号？免费注册</a>\n");
      out.write("\t\t</div>\n");
      out.write("\t</article>\n");
      out.write("\t<footer>\n");
      out.write("\t\t");
  ...
  private boolean _jspx_meth_s_005finclude_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /login.jsp(12,2) name = value type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005finclude_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /login.jsp(32,2) name = value type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
